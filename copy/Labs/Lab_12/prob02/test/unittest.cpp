...
TEST(Food, AccessorsMutators) {
  Food your_food;
  your_food.set_name("Chocolate cake");
  your_food.set_mass(500);
...
TEST(Utensil, AccessorsMutators) {
  ...
  your_utensil.set_size(7.5);
  your_utensil.set_color("platinum");
...
TEST(Spoon, AccessorMutator) {
  Spoon your_spoon;
  your_spoon.set_size(7.5);
  your_spoon.set_color("platinum");
  your_spoon.set_bite_size(100);
  ...
  ASSERT_EQ(your_spoon.bite_size(), 100)
...
TEST(Spoon, DefaultConstructor) {
  ...
  ASSERT_EQ(your_spoon.bite_size(), 25)
...
TEST(Spoon, ConstructorTest) {
  ...
  ASSERT_EQ(your_spoon.bite_size(), 35)

...
a function called `array_max` that should pass in an `int` array, and an 
`int` for the size of the array, respectively, and should return an `int` value.

Given an array of size 10 with contents:

# Cash Back
There are three credit card tiers available. The green card
...
the total cash back you receive. The program should ask the user to enter the type of card ('g' = green, 'y' = yellow, 'r' = red) as well as the amount of money spent. Display the amount of cash back earned showing 2 decimal places.

...
TEST(CombineBubbles, SameRadius) {
  ...
  ASSERT_EQ(combine_bubble(first_bubble, second_bubble).radius(), 12.4)
  ...
  ASSERT_DOUBLE_EQ(combine_bubble(first_bubble, second_bubble).volume(), 7986.2123946666661)
...
TEST(CombineBubbles, DifferentRadius) {
  ...
  ASSERT_EQ(combine_bubble(first_bubble, second_bubble).radius(), 9)
  ...
  ASSERT_DOUBLE_EQ(combine_bubble(first_bubble, second_bubble).volume(), 3053.5379999999996) 
